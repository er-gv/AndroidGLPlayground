...
extern "C" JNIEXPORT jboolean JNICALL com_ergv_glsandbox_ MyGLRenderer_init(JNIEnv* env, jobject /* this */) {
...
extern "C" JNIEXPORT jboolean JNICALL com_ergv_glsandbox_ MyGLRenderer_render(JNIEnv* env, jobject /* this */) {
