...
/// @file glm/matrix.hpp
///
/// @see <a href="http://www.opengl.org/registry/doc/GLSLangSpec.4.20.8.pdf">GLSL 4.20.8 specification, section 8.6 Transform Functions</a>
///
/// @defgroup core_func_matrix Transform functions
/// @ingroup core
///
