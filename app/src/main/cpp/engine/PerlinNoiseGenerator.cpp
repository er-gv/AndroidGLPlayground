...
class PerlinNoiseGenerator {
	...
	static void makeWhiteNoise2D(int n, float** result){
	...
	static float** makeOctaveNoise(int octave, const float** whiteNoise, int size){
		
		float** smoothNoise = new float*[size];
        for(int i=0; i<size; i++) {
            smoothNoise[i] = new float[size];
        }
