...
import com.ergv.quantizedshapes.ui.theme.QuantizedshapesTheme
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            Surface(
                ...
                VerticleMenu(
                    this,
                    arrayOf("CanadaIsCold", "Leumi for me", "I have the power!!1"),
            ...
            Image(
                ...
                modifier = Modifier
                    .clickable {
                        ...
                        if (caption == "CanadaIsCold")
                            intent.putExtra("scene_tag", "fractals")
                        else
                            intent.putExtra("sceneTag", "quantized_triangles")
